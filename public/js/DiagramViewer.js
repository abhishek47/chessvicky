...
};ChessPieceStyle["chesskid"]={"0":"png","30":"png","35":"png","38":"png","40":"png","45":"png","53":"png","60":"png","68":"png","75":"png","83":"png","90":"png","97":"png","105":"png","180":"png","default":"png"
...
};ChessPieceStyle["neo"]={"0":"png","30":"png","35":"png","38":"png","40":"png","45":"png","53":"png","60":"png","68":"png","75":"png","83":"png","90":"png","97":"png","105":"png","180":"png","default":"png"
...
getTarget:function(evt){return evt['pointer']?evt['pointer'].target:evt.target?evt.target:evt.srcElement;},

getPointXY:function(evt){if(evt['pointer'])
{return{x:evt['pointer'].x,y:evt['pointer'].y};}else
{var touches=evt.touches;var changedTouches=evt.changedTouches;var pointer={x:evt.pageX||(evt.clientX+(document.documentElement.scrollLeft||document.body.scrollLeft)),y:evt.pageY||(evt.clientY+(document.documentElement.scrollTop||document.body.scrollTop))
};if(touches&&touches[0]){pointer.x=touches[0].pageX;pointer.y=touches[0].pageY;}else if(changedTouches&&changedTouches[0]){pointer.x=changedTouches[0].pageX;pointer.y=changedTouches[0].pageY;}}return pointer;},
...
return-1;else
return 0;};if(!String.prototype.trim){String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,'');};}function nvl(z14d32,z4c3b0,z08196,zcf7fa)
...
var z569ea={observe:function(node,zf5b7d){var z5909b=("ontouchstart" in window);if(z5909b){z569ea.z99911(node,zf5b7d);}z569ea.z8b5b3(node,zf5b7d);},z99911:function(node,zf5b7d){var documentElement=document.documentElement;var zda629="touchend";var z8ed6c="touchstart";var z5098e="touchmove";var z43de0="touchcancel";var ze2286=1;var z4bed5;var z6275a;var z50f7a;var z51b36;var zfc167;var z0f6a8=false;var z5c381=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}event.cancelBubble=true;if(typeof event.stopPropagation==="function"){event.stopPropagation();}if(event.touches&&event.touches[0]){z51b36=event.touches[0].pageX;zfc167=event.touches[0].pageY;}else if(event.changedTouches&&event.changedTouches[0]){z51b36=event.changedTouches[0].pageX;zfc167=event.changedTouches[0].pageY;}if(z0f6a8){if(typeof zf5b7d.zc90d3==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"touch",target:z50f7a};zf5b7d.zc90d3.call(node,event);}}else{z0f6a8=(Math.abs(z51b36-z4bed5)>ze2286)||(Math.abs(zfc167-z6275a)>ze2286);if(z0f6a8){if(typeof zf5b7d.z9bfcc==="function"){event["pointer"]={x:z4bed5,y:z6275a,type:"touch",target:z50f7a};zf5b7d.z9bfcc.call(node,event);}}}};var z83a4f=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}z50f7a=event.target;if(event.touches&&event.touches[0]){z51b36=z4bed5=event.touches[0].pageX;zfc167=z6275a=event.touches[0].pageY;}else if(event.changedTouches&&event.changedTouches[0]){z51b36=z4bed5=event.changedTouches[0].pageX;zfc167=z6275a=event.changedTouches[0].pageY;}if(typeof zf5b7d.z35cc2==="function"){event["pointer"]={x:z4bed5,y:z6275a,type:"touch",target:z50f7a};zf5b7d.z35cc2.call(node,event);}myEvent.observe(documentElement,z5098e,z5c381);myEvent.observe(documentElement,zda629,z8887f);};var z8887f=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}if(z0f6a8){if(typeof zf5b7d.z1fe38==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"touch",target:z50f7a};zf5b7d.z1fe38.call(node,event);}}else{if(typeof zf5b7d.click==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"touch",target:z50f7a};zf5b7d.click.call(node,event);}}z4bed5=undefined;z6275a=undefined;z50f7a=undefined;z51b36=undefined;zfc167=undefined;z0f6a8=false;myEvent.stopObserving(documentElement,z5098e,z5c381);myEvent.stopObserving(documentElement,zda629,z8887f);};var z7d46d=function(event){z4bed5=undefined;z6275a=undefined;z50f7a=undefined;z51b36=undefined;zfc167=undefined;z0f6a8=false;myEvent.stopObserving(documentElement,z5098e,z5c381);myEvent.stopObserving(documentElement,zda629,z8887f);};myEvent.observe(node,z8ed6c,z83a4f);myEvent.observe(node,z43de0,z7d46d);},z8b5b3:function(node,zf5b7d){var z8c3e0=window.navigator.pointerEnabled||window.navigator.msPointerEnabled;if(z8c3e0){node.style["touchAction"]="none";node.style["msTouchAction"]="none";}var documentElement=document.documentElement;var z830d7=!!document.addEventListener;var zcc0f2="mouseup";var z15b75="mousedown";var z46d83="mousemove";var contextMenu="contextmenu";var zc2374=1;var zc8f01=1;var zb7879=3;var zec966=2;var ze2286=1;var z4bed5;var z6275a;var z50f7a;var ze9c85=false;var z0f6a8=false;var za2234=false;var zb2081=false;var z53989=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}event.cancelBubble=true;if(typeof event.stopPropagation==="function"){event.stopPropagation();}};var z5c381=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}var z51b36;var zfc167;if(z830d7){z51b36=event.pageX;zfc167=event.pageY;}else{z51b36=event.clientX+documentElement.scrollLeft;zfc167=event.clientY+documentElement.scrollTop;}if(z0f6a8){if(typeof zf5b7d.zc90d3==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.zc90d3.call(node,event);}}else if(za2234||zb2081){z0f6a8=(Math.abs(z51b36-z4bed5)>ze2286)||(Math.abs(zfc167-z6275a)>ze2286);if(z0f6a8){if(typeof zf5b7d.z9bfcc==="function"){event["pointer"]={x:z4bed5,y:z6275a,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.z9bfcc.call(node,event);}}}};var z4dc6b=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}var z51b36;var zfc167;if(z830d7){z51b36=event.pageX;zfc167=event.pageY;}else{z51b36=event.clientX+documentElement.scrollLeft;zfc167=event.clientY+documentElement.scrollTop;}if(z0f6a8){if(typeof zf5b7d.z1fe38==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.z1fe38.call(node,event);}}else if(za2234){if(typeof zf5b7d.click==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.click.call(node,event);}}else if(zb2081){if(typeof zf5b7d.z1a3ec==="function"){event["pointer"]={x:z51b36,y:zfc167,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.z1a3ec.call(node,event);}}if(typeof zf5b7d.z2f94f==="function"){event["pointer"]={x:z4bed5,y:z6275a,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.z2f94f.call(node,event);}z4bed5=undefined;z6275a=undefined;z50f7a=undefined;z0f6a8=false;za2234=false;zb2081=false;myEvent.stopObserving(documentElement,z46d83,z5c381);myEvent.stopObserving(documentElement,zcc0f2,z4dc6b);};var z4bf41=function(event){event.returnValue=false;if(typeof event.preventDefault==="function"){event.preventDefault();}if(event.which){za2234=event.which===zc2374;zb2081=event.which===zb7879;}else if(event.button){za2234=event.button===zc8f01;zb2081=event.button===zec966;}if(za2234||zb2081){if(z0f6a8){if(typeof zf5b7d.zedc6e==="function"){event["pointer"]={x:z4bed5,y:z6275a,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.zedc6e.call(node,event);}z0f6a8=false;}z50f7a=event.target||event.srcElement;if(z830d7){z4bed5=event.pageX;z6275a=event.pageY;}else{z4bed5=event.clientX+documentElement.scrollLeft;z6275a=event.clientY+documentElement.scrollTop;}if(typeof zf5b7d.z35cc2==="function"){event["pointer"]={x:z4bed5,y:z6275a,type:"mouse",target:z50f7a};event["isRightClick"]=zb2081;zf5b7d.z35cc2.call(node,event);}myEvent.observe(documentElement,z46d83,z5c381);myEvent.observe(documentElement,zcc0f2,z4dc6b);}};myEvent.observe(node,z15b75,z4bf41);myEvent.observe(node,contextMenu,z53989);}};
...
this.z074d9=nvl(this.zba64d["enabled"],true);this.z41465={size:0};this.z52f27={size:0};this.zfc921={};
this.z27781=[];this.size=nvl(this.zba64d["size"],45);
...
this.ze3e39=null;this.zcc381=false;this.zb525f=nvl(this.zba64d["markSourceSquare"],true);this.z39b23=nvl(this.zba64d["showHoverSquare"],true);this.z094b2='#FFF';this.z95296='20';
...
this.z9a8ba=false;this.z4b834=false;this.zbd74f=null;
this.z36890=false;this.zfed09={};
this.ze16a5=0;this.ze70ad=0;this.z4a892=nvl(this.zba64d["moveAnimationSpeed"],"normal");this.z297a3={"standard":0.2,"normal":0.2,"bullet":0,"blitz":0.1};
this.z086e8=0;this.z80320=false;
this.z64df9=false;

this.za31e4.chessBoard=this;
this.zce04d={};this.z911aa=[];
this.z15eec=true;
this.registerCustomEvent("onRenderReady");this.registerCustomEvent("onStartDragging");this.registerCustomEvent("onDragProgress");this.registerCustomEvent("onDropPiece");this.registerCustomEvent("onThrowPiece");this.registerCustomEvent("onClickPiece");this.registerCustomEvent("onClickArea");this.registerCustomEvent("onRightDown");this.registerCustomEvent("onRightClickPiece");this.registerCustomEvent("onRightClickArea");this.registerCustomEvent("onBuild");this.registerCustomEvent("onRefresh");this.registerCustomEvent("onMarkSquare");this.registerCustomEvent("onClearSquare");this.registerCustomEvent("onBlinkSquare");this.registerCustomEvent("onSetSquareColor");this.registerCustomEvent("onMarkArrow");this.registerCustomEvent("onClearArrow");this.registerCustomEvent("onClearMarkings");this.registerCustomEvent("onSetPieceStyle");this.registerCustomEvent("onSetColorScheme");this.registerCustomEvent("onSetBoardSize");this.registerCustomEvent("onSetBoardCoords");this.registerCustomEvent("onSetBoardCoordsPosition");this.registerCustomEvent("onSetBoardFlip");this.registerCustomEvent("onShowPromotionWindow");this.registerCustomEvent("onHidePromotionWindow");this.registerCustomEvent("onPromotionPieceSelected");this.registerCustomEvent("onMoveAnimation");this.registerCustomEvent("onAfterMoveAnimated");this.registerCustomEvent("onSetViewOnly");this.registerCustomEvent("onHidePieces");this.registerCustomEvent("onShowPieces");this.registerCustomEvent("onDynamicResize");
...
registerCustomEvent:function(zc19fd,context)
...
{
var zc7b94=this.z44f8e;
z569ea.observe(zc7b94,{z2f94f:z36b44.za347f,z35cc2:z36b44.z5e2f4,z9bfcc:z36b44.z7e559,zc90d3:z36b44.z5f302,z1fe38:z36b44.zaa601,zedc6e:this.zb3a64.bind(this),click:z36b44.ze12d8,z1a3ec:z36b44.zfa052,});}}},refresh:function(node)
...
{z4b0d0[zcc2ef].z2f7d7=true;}}},z2e9cd:function(e)
{if(this.zb525f)
{if(e['fromAreaId'])
{if(!this.z41465[e['fromAreaId']])
{this.z61307=this.z61307||{};var zb1b9d=(ChessColorScheme[this.zba7a5]&&ChessColorScheme[this.zba7a5][4])
?ChessColorScheme[this.zba7a5][4]
:this.z86a83;this.z02ba7(e['fromAreaId'],zb1b9d);this.z61307.z6205b=e['fromAreaId'];}}}},zed554:function()
{if(!this.z61307)
return;if(this.z61307.z6205b)
{this.z7690c(this.z61307.z6205b);delete this.z61307.z6205b;}},ze8146:function(zcc2ef,color,count,z87fe4)
...
zbfdfc["animationInstance"]=z36b44.ze0dc1(this);var zb2214=typeof(this.z297a3[this.z4a892])!="undefined"?this.z297a3[this.z4a892]:this.z297a3["normal"];var ze626b=nvl(zba64d["animationSpeed"],z36b44.z72000.z69de0*zb2214);zbfdfc["animationInstance"].ze8f55=ze626b;zbfdfc["animationInstance"].z6205b=z6205b;zbfdfc["animationInstance"].zb0082=zb0082;zbfdfc["animationInstance"].options=zba64d;var z6a34c=new Date().getTime();var zc5c61=z95894.z8c277.z326bd||z95894.z8c277.z18df3;if((this.z086e8+(ze626b*1000*1.5))<z6a34c&&!this.z80320&&!this.z64df9&&!zc5c61&&ze626b)
{
...
{setTimeout(function(){anim.zc8405.fireEvent("onAfterMoveAnimated",{"animationInstance":anim});anim.zc8405.z80320=false;},20);},z68050:function()
...
{if(this.z9a8ba)
{this.z9a8ba=false;this.z4b834=false;this.z659fc.z7a842();z36b44.z92068.z3dafa=null;}else if(this.z4b834)
{this.z9a8ba=false;this.z4b834=false;z36b44.z92068.z3dafa=null;}},z35c19:function(z1208e)
...
{if(this.z64df9)
{this.z64df9=false;this.fireEvent("onShowPieces");}},z8a6a4:function()
{if(this.z659fc.z8a6a4)
this.z659fc.z8a6a4();},zcbb2a:function()
{if(this.z659fc.zcbb2a)
this.z659fc.zcbb2a();},z8abf0:function()
{
...
z2c91b=null;}},zb1619:function(zcc2ef)
{return this.z659fc.zb1619(zcc2ef);}};}})();(function(){
if(typeof(z36b44)=='undefined'){z36b44={z72000:{z493f4:{},z8352a:z95894.z8c277.z2071e?30:10,zbe1b6:null,z54aa9:function(pos){return(-Math.cos(pos*Math.PI)/2)+0.5;},requestAnimationFrame:window["requestAnimationFrame"]
||window["oRequestAnimationFrame"]
||window["msRequestAnimationFrame"]
||window["mozRequestAnimationFrame"]
||window["webkitRequestAnimationFrame"],cancelAnimationFrame:window["cancelAnimationFrame"]
...
||window["webkitCancelRequestAnimationFrame"],zc2431:function(){return typeof this.requestAnimationFrame==="function"
&&/\[native code\]/.test(this.requestAnimationFrame.toString())
&&typeof this.cancelAnimationFrame==="function"
&&/\[native code\]/.test(this.cancelAnimationFrame.toString());},z69de0:1,zd732d:null,z3b879:false,initialized:false,options:{},init:function(options)
{if(this.initialized)
{return;}options=options||{};this.options=z19c31({},z36b44.z72000.z493f4,options);this.initialized=true;},start:function()
{if(!z36b44.z72000.z3b879)
{z36b44.z72000.zbe1b6=z36b44.z72000.requestAnimationFrame.call(window,z36b44.z68107);z36b44.z72000.z3b879=true;}},stop:function()
{if(z36b44.z72000.z3b879)
{z36b44.z72000.cancelAnimationFrame.call(window,z36b44.z72000.zbe1b6);z36b44.z72000.zbe1b6=null;z36b44.z72000.z3b879=false;}},z57f27:function()
{z36b44.z72000.zbe1b6=z36b44.z72000.requestAnimationFrame.call(window,z36b44.z68107);}},z7f400:[],ze0dc1:function(z93a29)
...
z56a67:null,
cancelable:true
};return z36b44.z7f400[z36b44.z7f400.length-1];},z68107:function(z40a96)
...
{zea6c9.z56a67(zea6c9);if(zea6c9.options&&typeof zea6c9.options.z56a67==="function")
{zea6c9.options.z56a67(zea6c9);}z36b44.z7f400.splice(n,1);n--;}}if(!z36b44.z7f400.length)
...
{
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;if(obj)
obj.z73d7f=false;},z5e2f4:function(e)
{z36b44.z14ccb(e);if(e["isRightClick"])
{
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;e["userGenerated"]=true;obj.fireEvent("onRightDown",e);}},z14ccb:function(e)
{if(!e["isRightClick"])
{
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;
if(obj)
obj.z8abf0();var z071ef=obj.z659fc.z7e90b(e.pointer);e["colRow"]=z071ef;
e["fromAreaId"]=z36b44.z92068.z6205b=obj.z659fc.z32f28(z071ef);
if(obj&&(obj.z27781.length||obj.z52f27.size)&&e["fromAreaId"])
{obj.z73d7f=true;e["userGenerated"]=true;obj.fireEvent("onClearMarkings",e);}}},z7e559:function(e)
{if(!e)
e=window.event;
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;var target=myEvent.getTarget(e);
if(obj)
obj.z8abf0();
var pointer=e["pointer"];var z071ef=obj.z659fc.z7e90b(pointer);e["colRow"]=z071ef;
e["fromAreaId"]=z36b44.z92068.z6205b=obj.z659fc.z32f28(z071ef);
obj.z6d5f7=e["fromAreaId"]==="";
z36b44.z92068.z3dafa=null;z36b44.z92068.za52be=null;z36b44.z92068.x=0;z36b44.z92068.y=0;
if(!obj||obj.z24380)
{return;}else if(!obj.z659fc.ze49f5(e)&&!e["isRightClick"])
{return;}
if(obj.z36890)
return;


var size=obj.size||obj.z659fc.zf741a();z36b44.z92068.z84efe=obj.ze16a5;z36b44.z92068.zc17fe=obj.ze16a5+(size*8);z36b44.z92068.z4b8ec=obj.ze70ad;z36b44.z92068.z3407c=obj.ze70ad+(size*8);if(!e["isRightClick"])
{if((obj.z27781.length||obj.z52f27.size||!obj.z074d9)&&(z071ef.z70fb8>0&&z071ef.z70fb8<=8)&&(z071ef.ze45e7>0&&z071ef.ze45e7<=8))
{e["userGenerated"]=true;obj.fireEvent("onClearMarkings",e);return;}obj.z9a8ba=false;obj.z4b834=false;z36b44.z92068.z3dafa=obj;z36b44.z92068.x=pointer.x;z36b44.z92068.y=pointer.y;obj.zed554();obj.z2e9cd(e);obj.fireEvent("onStartDragging",e);}else
{obj.z659fc.z7a842();obj.z9a8ba=false;obj.z4b834=false;if(obj.z6e1fb)
{if((z071ef.z70fb8>0&&z071ef.z70fb8<=8)&&(z071ef.ze45e7>0&&z071ef.ze45e7<=8))
{obj.zbd74f={z982f5:z071ef.z70fb8,z0db2a:z071ef.ze45e7,z6234d:z071ef.z70fb8,z5e2dd:z071ef.ze45e7};obj.z4b834=true;z36b44.z92068.z3dafa=obj;obj.fireEvent("onStartDragging",e);}}}return;},z5f302:function(e)
{if(!e)
e=window.event;
...
{var pointer=e["pointer"];var z8cbe4=z36b44.z92068.x;var z7fab6=z36b44.z92068.y;
...
pointer.z8cbe4=z8cbe4;pointer.z7fab6=z7fab6;var z071ef=obj.z659fc.z7e90b(pointer);e["colRow"]=z071ef;
if(!obj.z4b834)
{
...
{
setTimeout(function(){z36b44.z92068.z32e03=true;},z36b44.z92068.delay);}obj.z9a8ba=true;return;},zaa601:function(e)
{if(!e)
e=window.event;
var obj=z36b44.z92068.z3dafa;var target=myEvent.getTarget(e);
if(!obj)
return;var z071ef=obj.z659fc.z7e90b(e["pointer"]);var zf559c=obj.z659fc.z32f28(z071ef);if(obj.z9a8ba)
{
e["colRow"]=z071ef;e["targetAreaId"]=zf559c;e["fromAreaId"]=z36b44.z92068.z6205b;if(!obj.z4b834)
{if(obj.z36890)
{obj.z659fc.z7a842();this.z9a8ba=false;return;}if((z071ef.z70fb8<1||z071ef.z70fb8>8)||(z071ef.ze45e7<1||z071ef.ze45e7>8))
{
obj.fireEvent("onThrowPiece",e);obj.z9a8ba=false;return;}obj.zed554();obj.fireEvent("onDropPiece",e);obj.z9a8ba=false;return;}else
...
if(!z6bcb6)
{obj.z4413a(z6205b,zb0082,true);}}obj.z659fc.z2b279();obj.zbd74f=null;obj.z4b834=false;obj.z9a8ba=false;return;}}else
{if(obj.z4b834)
{obj.z659fc.z2b279();obj.zbd74f=null;obj.z4b834=false;obj.z9a8ba=false;}return;}return;},zf3760:function(e)
{if(!e)
e=window.event;
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;e["dropTargetId"]=obj.z659fc.z32f28(obj.z659fc.z7e90b(e["pointer"]));
if(!e["avoidCalculateOffset"])
obj.z8abf0();if(obj.z36890)
return false;if(e["dropTargetId"])
{obj.fireEvent("onClickArea",e);}return false;},ze12d8:function(e)
{if(!e)
e=window.event;
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;var target=myEvent.getTarget(e);e["dropTargetId"]=obj.z659fc.z32f28(obj.z659fc.z7e90b(e["pointer"]));if(obj.z6d5f7){
myEvent.preventDefault(e,true);return false;}if(obj.z24380){
myEvent.preventDefault(e,true);return false;}
obj.z8abf0();
z36b44.z92068.z3dafa=obj;z36b44.z92068.za52be=null;
if(e["dropTargetId"])
{if(!obj.z659fc.ze49f5(e))
{e["avoidCalculateOffset"]=true;z36b44.zf3760(e);myEvent.preventDefault(e,true);return false;}}if(obj.z36890)
...
{if(!e)
e=window.event;
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;var z54764=obj.z659fc.z32f28(obj.z659fc.z7e90b(e["pointer"]));if(obj.z6d5f7){
myEvent.preventDefault(e,true);return false;}if(obj.z24380)
{myEvent.preventDefault(e,true);return false;}
if(!e["avoidCalculateOffset"])
obj.z8abf0();if(obj.z36890)
...
{if(!e)
e=window.event;
var z6490c=myEvent.findComponent(e);var obj=z6490c?z6490c.chessBoard:null;var target=myEvent.getTarget(e);var z54764=obj.z659fc.z32f28(obj.z659fc.z7e90b(e["pointer"]));e["dropTargetId"]=z54764;if(obj.z24380){
myEvent.preventDefault(e,true);return false;}
...
};var zebccf=0.35;var z21aa7="-webkit-border-radius: 1000px; -moz-border-radius: 1000px; -ms-border-radius: 1000px; border-radius: 1000px;";var z3db9f="#000";var z98822=(window['devicePixelRatio']>1);var z35bfa=['p','n','k','q','r','b'];if(typeof(ze8b3a)=='undefined'){ze8b3a=function(zfb82d){this.zf7afd=zfb82d;
this.z85d5d=zfb82d.z85d5d;
this.z3044d=[{p:[],n:[],k:[],q:[],r:[],b:[]},{p:[],n:[],k:[],q:[],r:[],b:[]}];this.z4fda0={};
this.options=z493f4;
...
this.zf7afd.attachEvent("onRefresh",this.refresh);this.zf7afd.attachEvent("onBuild",this.build);this.zf7afd.attachEvent("onSetPieceStyle",this.zf4ec1);this.zf7afd.attachEvent("onSetColorScheme",this.z25bef);this.zf7afd.attachEvent("onSetBoardCoords",this.z4b778);this.zf7afd.attachEvent("onSetBoardCoordsPosition",this.z92965);this.zf7afd.attachEvent("onSetBoardSize",this.z01336);this.zf7afd.attachEvent("onSetBoardFlip",this.zcf3a1);this.zf7afd.attachEvent("onShowPromotionWindow",this.zee3e4);this.zf7afd.attachEvent("onHidePromotionWindow",this.z2b8eb);this.zf7afd.attachEvent("onPromotionPieceSelected",this.z8145f);this.zf7afd.attachEvent("onMarkSquare",this.z5b50b);this.zf7afd.attachEvent("onClearSquare",this.zdbbaa);this.zf7afd.attachEvent("onBlinkSquare",this.zfd011);this.zf7afd.attachEvent("onSetSquareColor",this.z742d6);this.zf7afd.attachEvent("onMarkArrow",this.z94199);this.zf7afd.attachEvent("onClearArrow",this.zf6e11);this.zf7afd.attachEvent("onClearMarkings",this.z201b5);this.zf7afd.attachEvent("onMoveAnimation",this.zfb0aa);this.zf7afd.attachEvent("onStartDragging",this.z05d61);this.zf7afd.attachEvent("onDragProgress",this.z0e2fe);this.zf7afd.attachEvent("onThrowPiece",this.z59010);this.zf7afd.attachEvent("onClickArea",this.z4ff97,this);this.zf7afd.attachEvent("onRightClickArea",this.z4ff97,this);this.zf7afd.attachEvent("onSetViewOnly",this.za65d8);this.zf7afd.attachEvent("onHidePieces",this.za19e1);this.zf7afd.attachEvent("onShowPieces",this.zd5b01);this.zf7afd.attachEvent("onDynamicResize",this.zbb3c6,this);z36b44.z72000.init();};
...
{this.zf7afd.z68050();this.zf7afd.zb3a64();this.za706a({zc2c05:true});
this.z94f9e();
this.zd6c99();
this.zcaed5();
this.zd50d7();
...
this.zbb9e9=z38c98?z38c98:53;}return this.zbb9e9;},za706a:function(zba64d)
...
za31e4.style.border='1px solid #777';},zb8387:function(callback)
...
this.zb4e33();},
refresh:function(e)
{this.z659fc.zd50d7();},zd50d7:function()
{if(!this.zf7afd.z64df9)
{this.z2914c();if(this.zf7afd.z27781.length)
this.zf0ad3();this.z76b02();}},zed5d2:function(zba125)
{var all=[];zd5512:for(var color=0;color<2;color++)
{z4f365:for(var t=0;t<6;t++)
{var type=z35bfa[t];var zad85d=this.z3044d[color][type];var length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{var z1efa8=zad85d[i];all.push(z1efa8);}}}return all;},z370f1:function(zba125)
{var areas={};zd5512:for(var color=0;color<2;color++)
{z4f365:for(var t=0;t<6;t++)
{var type=z35bfa[t];var zad85d=this.z3044d[color][type];var length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{var z1efa8=zad85d[i];areas[z1efa8.zba125]=z1efa8;}}}return areas;},z859cb:function()
{zd5512:for(var color=0;color<2;color++)
{z4f365:for(var t=0;t<6;t++)
{var type=z35bfa[t];var z2f7d7=[];var zad85d=this.z3044d[color][type];var length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{var z1efa8=zad85d[i];if(this.z4fda0[z1efa8.zba125])
{z2f7d7.push(z1efa8);}}z94706:while(z2f7d7.length)
{var z1efa8=z2f7d7.pop();length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{if(z1efa8===zad85d[i]){zad85d.splice(i,1);var element=z1efa8.element;var parent=element.parentNode;if(parent)
{parent.removeChild(element);}break ze1416;}}}}}this.z4fda0={};},za85e4:function(zba125)
{zd5512:for(var color=0;color<2;color++)
{z4f365:for(var t=0;t<6;t++)
{var type=z35bfa[t];var zad85d=this.z3044d[color][type];var length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{var z1efa8=zad85d[i];if(z1efa8.zba125===zba125)
{var element=z1efa8.element;var parent=element.parentNode;if(parent)
{parent.removeChild(element);}zad85d.splice(i,1);break zd5512;}}}}},z136a8:function()
{zd5512:for(var color=0;color<2;color++)
{z4f365:for(var t=0;t<6;t++)
{var type=z35bfa[t];var z2f7d7=[];var zad85d=this.z3044d[color][type];var length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{var z1efa8=zad85d[i];if(z1efa8.z2bf3b)
{z1efa8.z2bf3b=false;}else
{z2f7d7.push(z1efa8);}}z94706:while(z2f7d7.length)
{var z1efa8=z2f7d7.pop();length=zad85d.length;ze1416:for(var i=0;i<length;i++)
{if(z1efa8===zad85d[i]){zad85d.splice(i,1);var element=z1efa8.element;var parent=element.parentNode;if(parent)
{parent.removeChild(element);}break ze1416;}}}}}},z3f755:function()
{var zad85d=this.zed5d2();var length=zad85d.length;var url=this.z2242c;var format=this.zae745;for(var i=0;i<length;i++)
{var z1efa8=zad85d[i];var z0ec84=url+"/"+(z1efa8.color==1?"w":"b")+(z1efa8.type)+"."+format;z1efa8.element.src=z0ec84;}},z2914c:function()
{for(var zba125 in this.zf7afd.z7834f.areas)
{this.z567f7(zba125);}this.z136a8();this.z859cb();},z567f7:function(zdcd29)
{var z7834f=this.zf7afd.z7834f;var zba125=z7834f.areas[zdcd29];var zcc2ef=this.zf7afd.z85d5d+"_"+zdcd29;var size=this.zf7afd.size||this.zf741a();var z1efa8=null;var p=zba125.zad85d[0];if(p)
z1efa8=z7834f.zad85d[p];if(z1efa8)
{
var z1aadb;var z0ecc9=this.z3044d[z1efa8.color-1][z1efa8.type];var z67f18=z0ecc9.length;for(var zcc8f7=0;zcc8f7<z67f18;zcc8f7++)
{var z8eeac=z0ecc9[zcc8f7];
if(!z8eeac.z2bf3b)
{
if(z1aadb)
{if(z8eeac.zba125===zdcd29)
{z8eeac.z2bf3b=true;z1aadb.z2bf3b=false;z1aadb=z8eeac;}}else
{z8eeac.z2bf3b=true;z1aadb=z8eeac;}}}

var z2c2ca=z36b44.z92068.za52be;if(z2c2ca&&z1aadb&&z2c2ca===z1aadb.element&&z2c2ca.id==='img_'+zcc2ef)
return;var zd3fbb;if(z1aadb)
{zd3fbb=z1aadb.element;z1aadb.zba125=zdcd29;}var file=zdcd29.charCodeAt(0)-96;var z524fd=zdcd29.charCodeAt(1)-48;var zIndex=!this.zf7afd.z02e31?5+(8-z524fd):12-(8-z524fd);var top,left;if(!this.zf7afd.z02e31)
{top=size*(8-z524fd);left=size*(file-1);}else
{top=size*(z524fd-1);left=size*(8-file);}if(!zd3fbb)
{var z03bd4=new StringBuffer().append('<img id="img_').append(zcc2ef).append('" class="').append(this.zf7afd.z85d5d)
.append('_piece chess_com_piece" style="position: absolute; top: ').append(top).append('px; left: ').append(left)
.append('px; margin: 0px; padding: 0px; display: block; width: ').append(size).append('px; height: ')
.append(size).append('px; z-index: ').append(zIndex).append('; -webkit-transform: translateZ(0);" />').toString();insertContentAt(this.zf7afd.z44f8e,z03bd4,"top");zd3fbb=document.getElementById("img_"+zcc2ef);if(this.zf7afd.ze323a)
{Element.addClassName(zd3fbb,"chess_com_draggable");zd3fbb.style.cursor="pointer";}
this.z3044d[z1efa8.color-1][z1efa8.type].push({zba125:zdcd29,type:z1efa8.type,color:z1efa8.color,element:zd3fbb,z2bf3b:true,});}else
{
if(zd3fbb.id!=="img_"+zcc2ef)
zd3fbb.id="img_"+zcc2ef;if(zd3fbb.style.top!==top+"px")
zd3fbb.style.top=top+"px";if(zd3fbb.style.left!==left+"px")
zd3fbb.style.left=left+"px";if(zd3fbb.style.zIndex!=zIndex)
zd3fbb.style.zIndex=zIndex;if(zd3fbb.style.display!="block")
zd3fbb.style.display="block";}
var z0ec84=this.z2242c+"/"+(z1efa8.color==1?"w":"b")+(z1efa8.type)+"."+this.zae745;if(zd3fbb.src!==z0ec84)
zd3fbb.src=z0ec84;
...
{var z70579=new Image();z70579.onload=bind(function(zd3fbb,z70579,size){var za0ac9=parseInt(zd3fbb.style.width,10);var zc26c7=z70579.height/z70579.width;zd3fbb.style.height=(za0ac9*zc26c7)+'px';zd3fbb.style.marginTop='-'+((za0ac9*zc26c7)-(za0ac9))+'px';},this,zd3fbb,z70579,size);z70579.src=z0ec84;}else
{var za0ac9=parseInt(zd3fbb.style.width,10);var zc26c7=z70579.height/z70579.width;zd3fbb.style.height=(za0ac9*zc26c7)+'px';zd3fbb.style.marginTop='-'+((za0ac9*zc26c7)-(za0ac9))+'px';}}else
{if(zd3fbb.style.height!=size+'px')
zd3fbb.style.height=size+'px';if(zd3fbb.style.marginTop!='0')
zd3fbb.style.marginTop='0';}}else{this.z4fda0[zdcd29]=true;}},zcaed5:function()
{var i;var j;
var size=this.zf7afd.size||this.zf741a(),z4b003=this.z370f1(),z02e31=this.zf7afd.z02e31,z85d5d=this.zf7afd.z85d5d;for(var z1a290=0;z1a290<8;z1a290++)
{i=(!z02e31)?z1a290:7-z1a290;for(var z5950b=0;z5950b<8;z5950b++)
{j=(!z02e31)?z5950b:7-z5950b;var zba125=String.fromCharCode(97+z5950b)+(8-z1a290);var zcc2ef=z85d5d+"_"+zba125;if(z4b003[zba125])
{var zba3a2=z4b003[zba125].element.style;zba3a2.left=(j*size)+"px";zba3a2.top=(i*size)+"px";zba3a2.width=(size)+"px";zba3a2.height=(size)+"px";
if(z36b44.z92068.za52be&&(z36b44.z92068.za52be.id=="img_"+zcc2ef))
...
this.z1434a=z7c66b;},zd6c99:function(e)
...
{this.zf7afd.z41465[zcc2ef].color=zeca3a;zae1f8.style.backgroundColor=zeca3a;}}}}this.zb7119();this.zcbb2a();this.zf7afd.zd4da7();},ze4410:function()
...
{var size=this.zf7afd.size||this.zf741a();if(this.z05e2f)
{this.z05e2f.style.width=size+'px';this.z05e2f.style.height=size+'px';}for(var zcc2ef in this.zf7afd.z41465)
{if(this.zf7afd.z41465[zcc2ef].zf25e3)
...
if(this.zf7afd.zc9441)
{var z70c6b=this.zf7afd.z70c6b;var z41d20=new Image();z41d20.onload=function(){var width=z98822?z41d20.width/2:z41d20.width;var height=z98822?z41d20.height/2:z41d20.height;zbf562.marginTop='-'+(height-width)+'px';zbf562.height=height+'px';};z41d20.src=s+"q."+this.zb3264;var zd0142=new Image();zd0142.onload=function(){var width=z98822?zd0142.width/2:zd0142.width;var height=z98822?zd0142.height/2:zd0142.height;z83a90.marginTop='-'+(height-width)+'px';z83a90.height=height+'px';};zd0142.src=s+"n."+this.zb3264;var z9114a=new Image();z9114a.onload=function(){var width=z98822?z9114a.width/2:z9114a.width;var height=z98822?z9114a.height/2:z9114a.height;z64c40.marginTop='-'+(height-width)+'px';z64c40.height=height+'px';};z9114a.src=s+"r."+this.zb3264;var z00900=new Image();z00900.onload=function(){var width=z98822?z00900.width/2:z00900.width;var height=z98822?z00900.height/2:z00900.height;zb9462.marginTop='-'+(height-width)+'px';zb9462.height=height+'px';};z00900.src=s+"b."+this.zb3264;}},zb4e33:function()
...
this.z659fc.z2242c=null;this.z659fc.zae745=null;this.z659fc.z6700b();this.z533ad();this.z659fc.z8a6a4();this.z659fc.zb8387(bind(function(){this.z659fc.z74643();this.z659fc.z3f755();this.z659fc.zcbb2a();this.zd4da7();},this));},
z25bef:function(e)
{this.z533ad();this.z659fc.z8a6a4();this.z659fc.zb8387(bind(this.z659fc.zd6c99,this.z659fc,e));},
z4b778:function(e)
...
if(!zae1f8)
{zae1f8=document.createElement('div');zae1f8.style.position='absolute';zae1f8.style.zIndex='1';style=zae1f8.style;style.top=top+'px';style.left=left+'px';style.width=size+'px';style.height=size+'px';z4b0d0[zcc2ef].zf25e3=zae1f8;this.z44f8e.appendChild(zae1f8);}var opacity=z802da?'90':'50';if(e["legalMoveHint"])
opacity='20';if(typeof(zae1f8.style.opacity)!='undefined')
...
zf0839=color[1];color=zf0839;}if(e["legalMoveHint"])
color=z3db9f;style.backgroundColor=color;if(e["legalMoveHint"])
...
if(this.z39b23&&this.z659fc.z05e2f==null){this.z659fc.z05e2f=document.createElement('div');this.z659fc.z05e2f.style.width=size+'px';this.z659fc.z05e2f.style.height=size+'px';this.z659fc.z05e2f.style.zIndex='4';this.z659fc.z05e2f.style.position='absolute';this.z659fc.z05e2f.style.top=((e["colRow"].ze45e7-1)*size)+'px';this.z659fc.z05e2f.style.left=((e["colRow"].z70fb8-1)*size)+'px';this.z659fc.z05e2f.style.background=this.z094b2;this.z659fc.z05e2f.style.opacity=this.z95296/100;this.z659fc.z05e2f.style.filter='alpha(opacity='+this.z95296+')';this.z44f8e.appendChild(this.z659fc.z05e2f);}if(!this.z4b834)
{
...
{this.z659fc.z7a842();},
za65d8:function(e)
{var zad85d=this.z659fc.zed5d2();var length=zad85d.length;
if(this.z24380)
{for(var i=0;i<length;i++)
{
zad85d[i].element.style.cursor='default';}}else
{for(var i=0;i<length;i++)
{
zad85d[i].element.style.cursor='pointer';}}},
za19e1:function(e)
{var zad85d=this.z659fc.zed5d2();var length=zad85d.length;for(var i=0;i<length;i++)
zad85d[i].element.style.display='none';},
zd5b01:function(e)
...
{rows.reverse();cols.reverse();}return(z071ef.z70fb8==0)?"":(cols[z071ef.z70fb8-1]+String(rows[z071ef.ze45e7-1]));},zb1619:function(zcc2ef)
{this.zf7afd.z8abf0();var z70fb8=zcc2ef.charCodeAt(0)-96;var ze45e7=9-1*zcc2ef.charAt(1);if(this.zf7afd.z02e31)
{z70fb8=9-z70fb8;ze45e7=9-ze45e7;}var size=this.zf7afd.size||this.zf741a();var x=this.zf7afd.ze16a5+z70fb8*size-size/2;var y=this.zf7afd.ze70ad+ze45e7*size-size/2;return[x,y];}};}
...
{var target=zea6c9.target;target.style.top=zea6c9.z5f4b5+'px';target.style.left=zea6c9.zba570+'px';zea6c9.zc8405.z65158(zea6c9);}};}
...
return;this.z77fdf(this.z3ac0a+1);this.zd82a4[this.zd82a4.length-1]=this.zdf569.z2e5e5[this.z3ac0a];if(this.z0552b&&obj){var from=this.zdf569.z2e5e5[this.z3ac0a].z6205b;var to=this.zdf569.z2e5e5[this.z3ac0a].zb0082;var z3a3b9={};if(z084ac){z3a3b9['animationSpeed']=z084ac;}obj.ze0cab(from,to,z3a3b9);za6935=true;}}else if(action=="forward10")
...
document.getElementById(this.z3b7e0).style.display="none";},ze5645:function(z7fd67,direction,zf864d,z084ac){z7fd67=z7fd67||650;direction=direction||'forward';zf864d=zf864d==undefined?true:zf864d;var z36468=document.getElementById(this.z4afcf);if(this.ze8ef8)
...
{this.z07c01=setInterval(bind(z36b44.z47f54,this,z084ac),z7fd67);if(this.zdf569.z2e5e5.length-1==this.z3ac0a){this.zb5312("backwardBegin");}else{z36b44.z47f54.call(this,z084ac);
}}else
{this.z07c01=setInterval(bind(z36b44.z2ba6b,this,z084ac),z7fd67);if(!this.z3ac0a){this.zb5312("forwardEnd");}else{z36b44.z2ba6b.call(this,z084ac);
}}}}};})();
...
z36b44.z47f54=function(z084ac){if(this.zdf569.z2e5e5.length-1>this.z3ac0a)
{this.zb5312('forward1',null,null,z084ac);}else
{this.ze5645();}};
z36b44.z2ba6b=function(z084ac){if(this.z3ac0a)
{this.zb5312('backward1',null,null,z084ac);}else
...
{button.ze1dba.ze5645();}button.z070ef=setTimeout(function(){button.ze1dba.ze5645(500,direction,false,0.2);button.z070ef=setTimeout(function(){if(button.ze1dba.ze8ef8){button.ze1dba.ze5645();}button.ze1dba.ze5645(150,direction,false,0.1);},1000);},500);button.z42825=bind(z36b44.z39ab5,button);myEvent.observe(document,'mouseup',button.z42825);};z36b44.z39ab5=function(e)
{var button=this;if(button.z070ef){clearTimeout(button.z070ef);}if(button.ze1dba.ze8ef8)
...
{document.getElementById(this.z27f2c).innerHTML=this.z299fa;var z79011=document.getElementById(this.zac67e);if(this.z9b3d8.z3ac0a==this.z9b3d8.z2e5e5.length-1)
{this.zf0866=true;z79011.innerHTML='Solved!';z79011.className='success';}else
{this.zf0866=false;z79011.innerHTML=(z1f9e1?"Black to Move":"White to Move");z79011.className=(z1f9e1?"blackToMove":"whiteToMove");}}
},z65158:function(e)
{var za7157=this.chessBoard.z9b3d8.zd82a4.pop();this.chessBoard.refresh(za7157);this.z17d1d=false;},refresh:function(e)
...
{if(this.zf0866||this.z17d1d||!this.chessBoard.z074d9)
{this.chessBoard.z659fc.z7a842();return;}if(this.chessBoard.z9b3d8.z2e5e5.length==this.chessBoard.z9b3d8.z3ac0a+1)
{this.chessBoard.z659fc.z7a842();return;}this.zcd559.zea856(false);var zf8bdb=this.zcd559.z31a2a(z70602,zcc2ef,this.chessBoard.z7834f);var z49dd9=(zf8bdb)?true:false;if(z49dd9)
{z36b44.z92068.za52be=null;if(zf8bdb.z4e2bd)
this.chessBoard.zae48c(zdbb15,zcc2ef);else
this.zf5466(zdbb15,zcc2ef);}else
{this.zdacc7=false;this.chessBoard.z659fc.z7a842();this.refresh();}}},zd27a7:function(e)
{if(this.z71cab)
...
{this.z9b3d8.z77fdf(this.z9b3d8.z3ac0a-1);z9689c(this.chessBoard.z7834f,this.z9b3d8.z33622());this.zf0866=false;this.refresh();var z79011=document.getElementById(this.zac67e);z79011.innerHTML='Incorrect';z79011.className='failure';if(this.z52c71)
...
{if(this.z17d1d)
return;this.zf0866=true;document.getElementById(this.z27f2c).style.display='none';this.z9b3d8.show();this.refresh();}};var z588c0=function(e){if(!e)
e=window.event;
var target=e.target?e.target:e.srcElement;if(target.nodeType==3)
target=target.parentNode;if(target.nodeName.toLowerCase()!='input'&&target.type!="text"&&target.nodeName.toLowerCase()!='textarea'
&&zcf9ce&&(zcf9ce.setup.zb4ad2=="chessGame"||zcf9ce.zf0866)
&&!target.z2ec58)
{if(!target.z4a892){target.z4a892=0.2;}if(e.keyCode==39){
zcf9ce.z9b3d8.zb5312('forward1',null,null,target.z4a892);}else if(e.keyCode==37){
zcf9ce.z9b3d8.zb5312('backward1',null,null,target.z4a892);}else if(e.keyCode==38){
zcf9ce.z9b3d8.zb5312('backwardBegin');}else if(e.keyCode==40){
zcf9ce.z9b3d8.zb5312('forwardEnd');}if(e.keyCode==39||e.keyCode==37)
{target.z2ec58=true;if(!target.z1b971)
{target.zb4eae=0;target.z1b971=setInterval(function(){target.z2ec58=false;if(target.zb4eae>1){clearInterval(target.z1b971);target.z4a892=0.1;target.z1b971=setInterval(function(){target.z2ec58=false;},150);}},500);myEvent.observe(document,'keyup',z616b2);}}if(e.keyCode==39||e.keyCode==37||e.keyCode==38||e.keyCode==40){target.zb4eae++;myEvent.preventDefault(e,true);return false;}}};var z616b2=function(e){if(!e)
e=window.event;
var target=e.target?e.target:e.srcElement;if(target.nodeType==3)
target=target.parentNode;if(target.z1b971){clearInterval(target.z1b971);target.z1b971=null;target.z2ec58=false;target.zb4eae=0;target.z4a892=null;myEvent.stopObserving(document,'keyup',z616b2);}};myEvent.observe(document,'keydown',z588c0);})();window['fillChessDiagramDivs']=function(){var za6476=document.getElementsByClassName("chessDiagramDiv");var z13560=document.getElementsByClassName("dailyPuzzleDiv");var z47c36=function(n){new zba130(this[n]);this[n].style.padding='0';};for(var n=0;n<za6476.length;n++){if(!za6476[n].z975c1)
