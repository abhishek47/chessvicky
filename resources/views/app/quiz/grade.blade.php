...
@section('content')
  ...
  <div class="container">
   ...
   <div class="panel panel-border panel-purple">
       <div class="panel-heading">
              ...
              <h3>Total Questions : {{ $count }}  | Correct Answers : {{ $correct }}</h3>
          </div>
  ...
  <div class="panel panel-border panel-purple">
       <div class="panel-heading">
          ...
          <div class="panel-body">
                <a href="{{ url('/quiz') }}" class="btn btn-purple waves-effect waves-light" id="submit-quiz" >Back To Quizzes</a>
          </div>
  </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content p-0 b-0">
                                        <div class="panel panel-color panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <p>Voila! you completed the quiz!Let's review results.</p>
                                                 <br/>
