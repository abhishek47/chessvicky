                   ...
                   <div class="col-lg-8">
                       <div class="card-box">
                                    <form action="{{ url('profile/update') }}" method="post">
                                        <h5 class="text-muted text-uppercase m-t-0 m-b-20"><b>Edit Profile</b></h5>
                                         @include('partials.errors')
                                         {{ csrf_field() }}
                                           
                                        <p class="text-warning">Want to change profile picture? We pull it from <a target="_blank" href="http://www.gravatar.com">gravatar.com</a>!</p>   
                                        ...
                                        <div class="form-group m-b-20">
                                            <label>Your Bio <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="bio" rows="5" placeholder="Please enter description" >{{ $user->profile->bio }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <label>Country <span class="text-danger">*</span></label>
                                             <input type="hidden" id="countryValue" name="countryValue" value="{{ $user->profile->country }}" >
                                        ...
                                        <div class="form-group m-b-20">
                                            <label>Birthday <span class="text-danger">*</span></label>
                                             <input class="form-control" type="text" autocomplete="off" name="birthday" required="" placeholder="Birthday" data-mask="99/99/9999" value="{{ $user->birthday }}" >
                                 <span class="font-13 text-muted">(dd/mm/yyyy)</span>
                                        </div>

                                        <div class="form-group m-b-20">
                                            <label class="m-b-15">Gender <span class="text-danger">*</span></label>
                                            <br>
                                            <div class="radio radio-inline">
                                                <input type="radio" id="inlineRadio1" value="1" name="gender" {{ checked(1, $user->gender) }}>
                                                <label for="inlineRadio1"> Male </label>
                                            </div>
                                            <div class="radio radio-inline">
                                                <input type="radio" id="inlineRadio2" value="0" name="gender" {{ checked(0, $user->gender) }}>
                                                <label for="inlineRadio2"> Female </label>
                                            </div>
                                           
                                        </div>

                                       <button type="submit" class="btn w-sm btn-inverse waves-effect waves-light">
                                            Update Profile
                                        </button>
                                   </form>
