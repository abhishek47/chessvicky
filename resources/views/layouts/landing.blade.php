...
<div class="modal fade" id="akashModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3>Real Estate and Land Developers</h3>
        <p>Akash Developers is a leading real estate company in Nashik led by Mr. Pravin Wani and Akash Wani.Founded since 1982 Akash Developers has built various different Infrastructures.</p>
      </div>
